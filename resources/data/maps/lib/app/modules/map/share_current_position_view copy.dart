...
class SharePositionCView extends StatefulWidget {
  SharePositionCView({Key? key}) : super(key: key);

  @override
  State<SharePositionCView> createState() => _SharePositionCViewState();
}

class _SharePositionCViewState extends State<SharePositionCView> {
  List<Map> categories = [
    {
      'title': "Café",
