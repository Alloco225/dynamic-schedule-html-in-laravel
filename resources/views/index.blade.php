...
<main class="h-full flex flex-col justify-between">
    ...
    <section id="projects" class="py-5 bg-gray-100 ">
        <div class="container width flex justify-center">
            <div class="flex justify-between gap-5">
                ...
                <div class="rounded md:rounded-md w-20 h-20 md:w-24 md:h-24 bg-gray-300 hover:bg-gray-400 cursor-pointer overflow-hidden">
                    {{-- <a href="{{route('portfolio-zeromalaria')}}"> --}}
                    <a href="https://portfolio.amane.dev">
                        <img class="rounded md:rounded-md object-contain" src="/img/zeromalaria.png" alt="Estimate my app">
                    </a>
                </div>
                {{-- @endfor --}}

                <a href="{{route('new-project')}}" class=" relative rounded md:rounded-md w-20 h-20 md:w-24 md:h-24 bg-gray-300 hover:bg-gray-400 cursor-pointer p-5 flex justify-center items-center">
    ...
    <footer class="text-center bg-gray-700 text-white py-3 md:py-5" title="Amane Hosanna">
        あ
    </footer>
</main>
@endsection
